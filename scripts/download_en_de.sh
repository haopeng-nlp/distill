...
OUTPUT_DIR=/gscratch/ark/ivyg/fasttext-debias/distill/mbart/wmt_en_de
...
# rm ${OUTPUT_DIR}/valid.en_XX
for f in ${OUTPUT_DIR_DATA}/dev/dev/newstest20*.en; do
  echo $f
  cat $f >> ${OUTPUT_DIR}/valid.en_XX
done

# rm ${OUTPUT_DIR}/valid.de_DE
for f in ${OUTPUT_DIR_DATA}/dev/dev/newstest20*.de; do
echo $f
  cat $f >> ${OUTPUT_DIR}/valid.de_DE
done

mv ${OUTPUT_DIR_DATA}/test/test/newstest2016.en ${OUTPUT_DIR}/test.en_XX
mv ${OUTPUT_DIR_DATA}/test/test/newstest2016.de ${OUTPUT_DIR}/test.de_DE

rm ${OUTPUT_DIR}/newstest*
